...
e-axis: bin/E-AXIS/adapter-printer.stl bin/E-AXIS/print-fan-support.stl bin/E-AXIS/fs-lever.stl bin/E-AXIS/fs-cover.stl bin/E-AXIS/extruder-idler.stl bin/E-AXIS/adapter-printer.stl bin/E-AXIS/extruder-cover.stl
