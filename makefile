...
scratch: x-axis y-axis z-axis lcd e-axis
...
tarantula: x-axis y-axis z-axis lcd e-axis
...
y-axis: bin/Y-AXIS/y-rod-holder.stl bin/Y-AXIS/y-belt-idler.stl
...
bin/%.stl: Printed-Parts/SCAD/%.scad
	openscad -o $@ ${OPENSCAD_ARGS} -D 'extrusion_size=30' $<
